                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <c:forEach var="product" items="${listProducts}">
                                                <tr class="odd gradeA">
                                                    ...
                                                    <td class="center">${product.productImage}</td>
                                                    <td class="center">${product.productPrice}</td>
                                                    <td class="center">${product.productDescription}</td>
                                                    <td><a href="${pageContext.request.contextPath}/AdminProductServlet?command=delete&method=get&productID=${product.productID}">Purge</a></td>
                                                </tr>
                                            </c:forEach>
                                            </tbody>
                                        </table>
